...
do
   ...
   echo "**********************************";
   /usr/bin/mpg123 -s -2 -m "$filetoplay" | sudo /home/pi/scanpi/pifm/pifm - 90.0
   #/usr/bin/mpg123 -s -2 -m "$filetoplay" | sudo /home/pi/scanpi/pirate_pifm/pifm - 90.0
